...
class GNN_TAU_RL_AC(Network):
    def __init__(self, net_params, network=None):
        ...
        self.value_estimation = nn.Sequential(
            nn.Linear(h_dimension, hidden_dim),
            nn.LeakyReLU(),
    ...
    def forward(self, data):
        ...
        value = torch.mean(self.value_estimation(h).squeeze(-1), dim=-1)
